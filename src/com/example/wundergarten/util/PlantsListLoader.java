...
public class PlantsListLoader extends AsyncTaskLoader<ArrayList<Plant>>
	 ...
	 */
    protected ArrayList<Plant> mItems;
     ...
     * @param context
     */
    public PlantsListLoader(Context context) {
        super(context);
    }
     ...
     */
    @Override 
    public ArrayList<Plant> loadInBackground() {
    	return loadItems();
    }
     ...
     */
    @Override 
    public void deliverResult(ArrayList<Plant> items) {
        if (isReset()) {
        ...
        ArrayList<Plant> oldItems = items;
        mItems = items;
     ...
     */
    @Override 
    public void onCanceled(ArrayList<Plant> items) {
     ...
     */
    protected void onReleaseResources(ArrayList<Plant> items) {
     ...
     */
    protected ArrayList<Plant> loadItems() {
		...
		try {
			...
			Log.i(TAG, result);
			items = MijnTuinJSONParser.getPlants(result);
