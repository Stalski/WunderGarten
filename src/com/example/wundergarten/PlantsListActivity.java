 ...
 * PlantsListActivity
 */
public class PlantsListActivity extends WundergartenActivityBase
	...
	public void loadPage() {
		Log.i(TAG, "PlantsListActivity::LoadPage ! Nothing to do anymore here :)");
	}
	...
	public void onItemSelected(String id) {
		...
		if (mTwoPane) {
			Log.i(TAG, TAG + " in two pane mode with id: " + id);
			...
			Log.i(TAG, TAG + " in single pane mode with id: " + id);
